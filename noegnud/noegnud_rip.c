...
noegnud_rip_outrip_finalize(winid tmpwin)
{
    ...
    rip_image = noegnud_collection_data(noegnud_options,
                                        "gui.window.tombstone.image");
    rip_font =
        noegnud_collection_data(noegnud_options, "gui.window.tombstone.font");

    rip_width = noegnud_collection_data(noegnud_options,
                                        "gui.window.tombstone.width");

    rip_name_x = noegnud_collection_data(noegnud_options,
                                         "gui.window.tombstone.name.x");
    rip_name_y = noegnud_collection_data(noegnud_options,
                                         "gui.window.tombstone.name.y");
    rip_year_x = noegnud_collection_data(noegnud_options,
                                         "gui.window.tombstone.year.x");
    rip_year_y = noegnud_collection_data(noegnud_options,
                                         "gui.window.tombstone.year.y");
    rip_gold_x = noegnud_collection_data(noegnud_options,
                                         "gui.window.tombstone.gold.x");
    rip_gold_y = noegnud_collection_data(noegnud_options,
                                         "gui.window.tombstone.gold.y");
    rip_how_x = noegnud_collection_data(noegnud_options,
                                        "gui.window.tombstone.how.x");
    rip_how_y = noegnud_collection_data(noegnud_options,
                                        "gui.window.tombstone.how.y");
    ...
    widget_text = noegnud_gui_create_text(
        ...
        rip_tomb_colour->g, rip_tomb_colour->b, plname);
    ...
    widget_text = noegnud_gui_create_text(
        ...
        stringwidth, rip_font_font->height, rip_tomb_colour->r,
        rip_tomb_colour->g, rip_tomb_colour->b, buf);
    widget_text->font = rip_font_font;
    widget_text->dynamiccharwidth = TRUE;
...
noegnud_rip_outrip(winid tmpwin, int how)
{
    ...
    rip_description_x = noegnud_collection_data(
