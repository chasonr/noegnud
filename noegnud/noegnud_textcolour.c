...
char *
noegnud_textcolour_rgba_pbuffer(const char *haystack,
                                struct re_pattern_buffer *needle, float br,
                                float bg, float bb, float ba, float ar,
                                float ag, float ab, float aa)
{
    ...
    if ((rx_pos = re_search(needle, haystack, strlen(haystack), 0,
        ...
        if ((rx_len = re_match(needle, haystack, strlen(haystack), rx_pos, 0))
            > 0) {
            szRetch = szReturn =
                noegnud_mem_malloc(strlen(haystack) + 7 + 7 + 1);
...
char *
noegnud_textcolour_rgba_text(const char *haystack, const char *needle,
                             float br, float bg, float bb, float ba, float ar,
                             float ag, float ab, float aa)
{
    struct re_pattern_buffer *pbuffer;
    char *regex_error;
    ...
    if ((regex_error =
        ...
        szReturn = noegnud_textcolour_rgba_pbuffer(haystack, pbuffer, br, bg,
                                                   bb, ba, ar, ag, ab, aa);
    }
...
char *
noegnud_textcolour_font_pbuffer(const char *haystack,
                                struct re_pattern_buffer *needle, void *bf,
                                void *af)
{
    return (char *) haystack;
}
...
char *
noegnud_textcolour_font_text(const char *haystack, const char *needle,
                             void *bf, void *af)
{
    return (char *) haystack;
}
...
char *
noegnud_textcolour_underline_pbuffer(const char *haystack,
                                     struct re_pattern_buffer *needle, int bu,
                                     int au)
{
    return (char *) haystack;
}
...
char *
noegnud_textcolour_underline_text(const char *haystack, const char *needle,
                                  int bu, int au)
{
    return (char *) haystack;
}
...
char *
noegnud_textcolour_bold_pbuffer(const char *haystack,
                                struct re_pattern_buffer *needle, int bb,
                                int ab)
{
    return (char *) haystack;
}
...
char *
noegnud_textcolour_bold_text(const char *haystack, const char *needle, int bb,
                             int ab)
{
    return (char *) haystack;
}
...
char *
noegnud_textcolour_italics_pbuffer(const char *haystack,
                                   struct re_pattern_buffer *needle, int bi,
                                   int ai)
{
    return (char *) haystack;
}
...
char *
noegnud_textcolour_italics_text(const char *haystack, const char *needle,
                                int bi, int ai)
{
    return (char *) haystack;
}
