...
char *noegnud_textcolour_rgba_text(const char *haystack, const char *needle,
                                   float br, float bg, float bb, float ba,
                                   float ar, float ag, float ab, float aa);
...
char *noegnud_textcolour_font_pbuffer(const char *haystack,
                                      struct re_pattern_buffer *needle,
                                      void *bf, void *af);
char *noegnud_textcolour_font_text(const char *haystack, const char *needle,
                                   void *bf, void *af);
...
char *noegnud_textcolour_underline_text(const char *haystack,
                                        const char *needle, int bu, int au);

char *noegnud_textcolour_bold_pbuffer(const char *haystack,
                                      struct re_pattern_buffer *needle,
                                      int bb, int ab);
char *noegnud_textcolour_bold_text(const char *haystack, const char *needle,
                                   int bb, int ab);
...
char *noegnud_textcolour_italics_text(const char *haystack,
                                      const char *needle, int bi, int ai);
