...
void noegnud_fonts_printchar_scaled(noegnud_fonts_tfont *font,
                                    unsigned char ch, float scale_x,
                                    float scale_y);
...
void noegnud_fonts_printchar_dynamic(noegnud_fonts_tfont *font,
                                     unsigned char ch);
