...
void noegnud_gui_widget_addchild(noegnud_gui_twidget *widget,
...
void noegnud_gui_widget_addchikillld(noegnud_gui_twidget *widget,
                                     noegnud_gui_twidget *child);
void noegnud_gui_widget_addsibling(noegnud_gui_twidget *widget,
                                   noegnud_gui_twidget *sibling);

void noegnud_gui_kill_widget_relatives(noegnud_gui_twidget *widget);

void noegnud_gui_offset_widget(noegnud_gui_twidget *widget, int offset_x,
                               int offset_y);
...
noegnud_gui_tprogressbar *noegnud_gui_create_progressbar(
    noegnud_gui_twidget *parent, int x, int y, int width, int height,
    GLfloat r, GLfloat g, GLfloat b, GLfloat a, int minimum, int maximum,
    GLfloat br, GLfloat bg, GLfloat bb, GLfloat ba);
void noegnud_gui_draw_progressbar(noegnud_gui_tprogressbar *progress,
                                  int drawchildren);
...
noegnud_gui_tglyph *noegnud_gui_create_glyph(noegnud_gui_twidget *parent,
                                             int x, int y, int width,
...
void noegnud_gui_event_vscroll(noegnud_gui_tvscroll *vscroll,
                               SDL_Event *event);
void noegnud_gui_autosize_vscroll(noegnud_gui_tvscroll *vscroll);

void noegnud_gui_draw_vslider(noegnud_gui_tvslider *vslider,
                              int drawchildren);
...
noegnud_gui_tmenuitem *noegnud_gui_create_menuitem(
    noegnud_gui_twidget *parent, int x, int y, int width, int height,
    GLfloat r, GLfloat g, GLfloat b, GLfloat a, anything identifier, char ch,
    char gch, int selected);
void noegnud_gui_draw_menuitem(noegnud_gui_tmenuitem *menuitem,
                               int drawchildren);
void noegnud_gui_event_menuitem(noegnud_gui_tmenuitem *menuitem,
                                SDL_Event *event);
